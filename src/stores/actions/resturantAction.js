...
import { GET_ALL_MERCHANT_PROCESSING, GET_ALL_MERCHANT_PROCESSED, ERROR } from "../constants"
...
export const getAllMerchant = (user) => {
    return async (dispatch, getState) => {
      ...
      try {
        ...
        let {data} = await getApi(`${base_url}/merchants/get_all_merchants`, '' , authToken)
